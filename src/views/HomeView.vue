<template>
  <div>
    ...
    <div
      class="border-2 border-dashed rounded-lg border-neutral-300 dark:border-neutral-600 h-96 mb-4"
    />
    <div class="grid grid-cols-2 gap-4 mb-4">
      <div
        class="border-2 border-dashed rounded-lg border-neutral-300 dark:border-neutral-600 h-48 md:h-72"
      />
      <div
        class="border-2 border-dashed rounded-lg border-neutral-300 dark:border-neutral-600 h-48 md:h-72"
      />
